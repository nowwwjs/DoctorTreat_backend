	...
	<main>
		...
		<div id="disease-title-first">
			...
			<div class="disease-section-first">
				<div class="disease-detail-first">
					<a href="bookDetail.jsp?page=1">위염</a>
				</div>
				<div class="disease-detail-first">
					<a href="bookDetail.jsp?page=2">공황 발작</a>
				</div>
				<div class="disease-detail-first">
					<a href="bookDetail.jsp?page=3">결장암</a>
				</div>
				<div class="disease-detail-first">
					<a href="bookDetail.jsp?page=4">기흉</a>
				</div>
				<div class="disease-detail-first">
					<a href="bookDetail.jsp?page=5">난독증</a>
				</div>
			</div>
		</div>
		...
		<div id="disease-title-second">
			...
			<div class="disease-section-second">
				<div class="disease-detail-second">
					<a href="bookDetail.jsp?page=6">외이도염</a>
				</div>
				<div class="disease-detail-second">
					<a href="bookDetail.jsp?page=7">당뇨병</a>
				</div>
				<div class="disease-detail-second">
					<a href="bookDetail.jsp?page=8">3도 동상</a>
				</div>
				<div class="disease-detail-second">
					<a href="bookDetail.jsp?page=9">패혈증</a>
				</div>
				<div class="disease-detail-second">
					<a href="bookDetail.jsp?page=10">골다 골증</a>
				</div>
			</div>
		</div>
	</main>
