        ...
        <div id="main-ad" class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="${pageContext.request.contextPath}/static/image/logo1.png" />
                </div>
                <div class="swiper-slide">
                    <img src="${pageContext.request.contextPath}/static/image/row2.jpeg" />
                </div>
                <div class="swiper-slide">
                    <img src="${pageContext.request.contextPath}/static/image/row3.jpeg" />
                </div>
            </div>
        </div>
    </main>
