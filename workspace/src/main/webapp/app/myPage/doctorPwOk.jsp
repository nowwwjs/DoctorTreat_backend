...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/myPage/doctorPwOk.css">
...
<body>
    ...
    <div class="DoctorpwOk-main-container">
        ...
        <button class="DoctorpwOk-btn"><a href="DoctorupdateMember.html">인증완료</a></button>
    </div>
    <footer>
        <br>
    ...
    <script src="${pageContext.request.contextPath}/static/js/myPage/doctorPwOk.js"></script>
</body>
