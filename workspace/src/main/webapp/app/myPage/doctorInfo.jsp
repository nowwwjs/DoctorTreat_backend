...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/myPage/doctorInfo.css">
      ...
      <div class="DoctorInfo-main-container">
        ...
        <div class="DoctorInfo-inputbox">
          <form action="">
            ...
            <label class="DoctorInfo-input" for="">
              <span>아이디</span>
        ...
        <button class="DoctorInfo-btn"><a href="DoctorpwOk.html">병원정보수정</a></button>
