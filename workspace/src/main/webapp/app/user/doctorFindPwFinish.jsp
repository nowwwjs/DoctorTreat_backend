...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/user/doctorFindPwFinish.css">
  <link rel="stylesheet" href="./../../../css/main/basic.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
  <title>DoctorTreat - 현재비밀번호</title>
</head>
<body>
  <header>
    <div id="header-fixed">
  ...
  <main>
    ...
    <div class="Doctor-findfinish-container">
      <h2 class="Doctor-findfinish-page-title">현재비밀번호</h2>
      <br>
      <div class="Doctor-findfinish-choicebox">
        <div class="Doctor-findfinish-choice"><a href="./../../../html/user/doctor/DoctorfindId.html">아이디찾기</a></div>
        <div class="Doctor-findfinish-choice"><a href="./../../../html/user/doctor/DoctorfindPw.html">비밀번호찾기</a></div>
      </div>
      <br><br>
      <section class="Doctor-findfinish-form-one">
          <p class="Doctor-findfinish-p">@@@ 회원님의 비밀번호입니다.</p>
      </section> 
        <br>
      <section class="Doctor-findfinish-form-two">
        <form>
          비밀번호 <input type="text" class="Doctor-findfinish-input" placeholder="나중에 보더라인,플레이스홀더는 지울거에요">      
        </form>
      </section>
      <br><br><br>
      <a href="./../../../html/user/doctor/Doctorlogin.html"><button type="submit" class="Doctor-findfinish-button">로그인</button></a>
    </div>
  </main>
  <footer>
    <br>
