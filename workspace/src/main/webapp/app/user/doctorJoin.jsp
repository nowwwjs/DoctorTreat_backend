			...
			<form
				...
				<div class="Doctor-input-group">
					<input type="text" id="doctorPhoneNumber" name="doctorPhoneNumber"
						required>
					<button type="button" id="smsButton" class="Doctor-join-request">인증
						요청</button>
					<p class="Doctorjoin-Null"></p>
				</div>
				...
				<div class="Doctor-input-group">
					<div id="doctorPhoneBox">
						...
						<button type="button" id="phonecheck3" class="Doctor-join-request">인증
							완료</button>
						<p id="phoneCheck"></p>
					</div>
				</div>
				...
				<br> <label for="doctorMedicalSubject">진료과목<br>
					<br> <input type="radio" value="내과" id="doctor-subject-inner"
					name="doctorMedicalSubject"" checked>내과&nbsp&nbsp <input
					type="radio" value="이비인후과" id="doctor-subject-ear" name="doctorMedicalSubject">이비인후과
				</label> <br><br><br>
