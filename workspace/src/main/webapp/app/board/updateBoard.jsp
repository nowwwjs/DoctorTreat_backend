...
<body>
	<main>
		...
		<form class="member-write-wrap-update"
			action="${pageContext.request.contextPath}/updateBoardOk.membo?infoNumber3=${memberBoardshowDetail.medicalInfoNumber}"
			method="post">
			<input class="member-write-title-update" type="text"
				name="updateTitle" value="${memberBoardshowContent.medicalInfoTitle}">
			<textarea id="summernote" class="member-write-content-update" name="updateText">${memberBoardshowContent.medicalInfoText}</textarea>
