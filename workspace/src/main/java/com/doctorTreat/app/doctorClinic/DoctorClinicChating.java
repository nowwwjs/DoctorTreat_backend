...
import com.doctorTreat.app.memberClinic.MemberClinicChating;

// 일반 유저에서 서버간의 웹 소켓 url
@ServerEndpoint("/DoctorClinicChating")
//	public class BroadSocket {
public class DoctorClinicChating {
	...
	public void handleClose(Session userSession) {
		...
		if (user != null) {
			...
			MemberClinicChating.bye(user.key);
